...
#The list below, tuples_lst, is a list of tuples. Create a list of the second elements
#of each tuple and assign this list to the variable country.
...
for ch in tuples_lst:
    country.append(ch[1])


#With only one line of code, assign the variables city, country, and year to the
#values of the tuple olymp.
...
#that contains only the number of medals for each country. You must use the .items() method.
...
for ch in gold.items():
    num_medals.append(ch[1])
