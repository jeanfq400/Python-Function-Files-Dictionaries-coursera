...
#number or a string but whose default is 6. The function should return the first
...
#the code works. The function should still have a required parameter, intx, and an
...
#optional boolean whose default value is True, and an optional dictionary,
...
# dictionary. The value of that key should then be returned. If the boolean
...
#The first is a required parameter, which should be a string. The second is an
#optional parameter called direction with a default value of True.
...
# is in the third, dictionary, input parameter, then the function returns that value,
...
c_true = checkingIfIn('apple', False ,{'dog':3, 'cat':9, 'chicken':8, 'tiger':100})
# Call the function so that the value of fruit is assigned to the variable fruit_ans
fruit_ans = checkingIfIn('fruit')
# Call the function using the first and third parameter so that the value 8 is assigned to the variable param_check
param_check = checkingIfIn('chicken', False, {'dog':3, 'cat':9, 'chicken':8, 'tiger':100})
