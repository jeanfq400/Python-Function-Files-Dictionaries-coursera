...
#Given the same dictionary, medals, now sort by the medal count. Save the three
...
#Create a function called last_four that takes in an ID number and returns the last
#four digits. For example, the number 17573005 should return 3005.
#Then, use this function to sort the list of ids stored in the variable, ids,
#from lowest to highest. Save this sorted list in the variable, sorted_ids. Hint:
